...
public final class FragmentBannerBinding implements ViewBinding {
  ...
  private FragmentBannerBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgBanner) {
  ...
  public static FragmentBannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBannerBinding((RelativeLayout) rootView, imgBanner);
    }
