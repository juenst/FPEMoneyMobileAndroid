...
import lib.finpay.sdk.corekit.model.RegisAccMerchant
...
class RegisAccMerchantRepository() {
    ...
    companion object {
        ...
        fun regisAccMerchant(
            ...
            custName: String,
            transType: String,
            onSuccess: (RegisAccMerchant) -> Unit,
            onFailed: (String) -> Unit
                ...
                request.regisAccMerchant(requestBody).enqueue(object : Callback<RegisAccMerchant> {
                    override fun onFailure(call: Call<RegisAccMerchant>, t: Throwable) {
                        onFailed(t.message.toString())
                    }
                    override fun onResponse(
                        call: Call<RegisAccMerchant>,
                        response: Response<RegisAccMerchant>
                    ) {
