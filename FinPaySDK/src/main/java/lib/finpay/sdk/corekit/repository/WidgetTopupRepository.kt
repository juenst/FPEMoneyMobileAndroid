    ...
    companion object {
        ...
        fun widgetTopUp(
            ...
            onFailed: (String) -> Unit
                ...
                request.widgetTopUp(requestBody).enqueue(object : Callback<WidgetTopUp> {
                    override fun onFailure(call: Call<WidgetTopUp>, t: Throwable) {
                        onFailed(t.message.toString())
                    }
                    override fun onResponse(
                        call: Call<WidgetTopUp>,
                        response: Response<WidgetTopUp>
                    ) {
