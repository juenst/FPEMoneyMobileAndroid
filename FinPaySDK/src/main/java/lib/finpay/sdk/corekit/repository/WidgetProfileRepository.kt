...
import lib.finpay.sdk.corekit.model.WidgetProfile
    ...
    companion object {
        ...
        fun widgetProfile(
            ...
            onFailed: (String) -> Unit
                ...
                request.widgetProfile(requestBody).enqueue(object : Callback<WidgetProfile> {
                    override fun onFailure(call: Call<WidgetProfile>, t: Throwable) {
                        onFailed(t.message.toString())
                    }
                    override fun onResponse(
                        call: Call<WidgetProfile>,
                        response: Response<WidgetProfile>
                    ) {
