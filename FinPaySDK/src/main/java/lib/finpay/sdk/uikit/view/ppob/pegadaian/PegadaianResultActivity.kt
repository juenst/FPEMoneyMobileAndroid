...
class PegadaianResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pegadaian_result)
        ...
        progressDialog = ProgressDialog(this@PegadaianResultActivity)
        ...
        btnConfirm.setOnClickListener {
            ...
            if(type == "angsuranmikro") {
                productCodes = ProductCode.ANGSURAN_MIKRO
                transactionTypes = "Pembayaran Tagihan Angsuran Mikro"
            } else if(type == "cicilgadai"){
                productCodes = ProductCode.CICIL_GADAI
                transactionTypes = "Pembayaran Tagihan Cicil Gadai"
            } else if(type == "gadaitebus"){
                productCodes = ProductCode.GADAI_TEBUS
                transactionTypes = "Pembayaran Tagihan Gadai Tebus"
            } else if(type == "tabunganemas"){
                productCodes = ProductCode.TABUNGAN_EMAS
                transactionTypes = "Pembayaran Tagihan Tabungan Emas"
            }else if(type == "ulanggadai"){
                productCodes = ProductCode.ULANG_GADAI
                transactionTypes = "Pembayaran Tagihan Ulang Gadai"
            }

            println("productCodes at Pegadaian : $productCodes")
            println("transactionType at Pegadaian : $transactionTypes")
    ...
    fun getUserBallance() {
        ...
        progressDialog.show()
        FinpaySDK.getUserBallance(transNumber!!, this@PegadaianResultActivity, {
            saldo = it.amount!!
            progressDialog.dismiss()
        },{
            progressDialog.dismiss()
            DialogUtils.showDialogError(this@PegadaianResultActivity, "", it, finpayTheme)
        })
    }
}