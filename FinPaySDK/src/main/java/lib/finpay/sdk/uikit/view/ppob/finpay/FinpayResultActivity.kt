package lib.finpay.sdk.uikit.view.ppob.finpay
...
class FinpayResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_finpay_result)
        ...
        progressDialog = ProgressDialog(this@FinpayResultActivity)
                ...
                TextUtils.clearFormat(fee),
                {
                    ...
                    FinpaySDK.authPin(
                        ...
                        ProductCode.FINPAY, {
                            ...
                            intent.putExtra("productCode", ProductCode.FINPAY)
                            ...
                            intent.putExtra("transactionType", "Topup Finpay Money")
    ...
    fun getUserBallance() {
        ...
        progressDialog.show()
        FinpaySDK.getUserBallance(transNumber!!, this@FinpayResultActivity, {
            saldo = it.amount!!
            progressDialog.dismiss()
        },{
            progressDialog.dismiss()
            DialogUtils.showDialogError(this@FinpayResultActivity, "", it, finpayTheme)
        })
    }
}