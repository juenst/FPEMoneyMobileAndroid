...
class InternetTvCableResultActivity : AppCompatActivity() {
val result: PpobInquiry? by lazy { if(intent.getSerializableExtra("result") == null) null else intent.getSerializableExtra("result") as PpobInquiry }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressDialog = ProgressDialog(this@InternetTvCableResultActivity)
    ...
    fun getUserBallance() {
        ...
        progressDialog.show()
        FinpaySDK.getUserBallance(transNumber!!, this@InternetTvCableResultActivity, {
            saldo = it.amount!!
            progressDialog.dismiss()
        },{
            progressDialog.dismiss()
            DialogUtils.showDialogError(this@InternetTvCableResultActivity, "", it, finpayTheme)
        })
    }
}