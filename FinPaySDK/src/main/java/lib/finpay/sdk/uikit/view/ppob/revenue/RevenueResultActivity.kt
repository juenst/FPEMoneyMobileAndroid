...
class RevenueResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        progressDialog = ProgressDialog(this@RevenueResultActivity)
        ...
        btnConfirm.setOnClickListener {
            ...
            if(type == "cukai") {
                productCodes = ProductCode.REVENUE_CUKAI
                transactionTypes = "Pembayaran Tagihan Bea cukai"
            } else if(type == "pajakonline"){
                productCodes = ProductCode.REVENUE_ONLINE
                transactionTypes = "Pembayaran Tagihan Cicil Gadai"
            } else if(type == "pnbp"){
                productCodes = ProductCode.REVENUE_PNBP
    ...
    fun getUserBallance() {
        ...
        progressDialog.show()
        FinpaySDK.getUserBallance(transNumber!!, this@RevenueResultActivity, {
            saldo = it.amount!!
            progressDialog.dismiss()
        },{
            progressDialog.dismiss()
            DialogUtils.showDialogError(this@RevenueResultActivity, "", it, finpayTheme)
        })
    }
}